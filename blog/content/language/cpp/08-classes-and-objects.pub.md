---
title: "[C++ 학습 노트 08] 클래스와 객체"
description: "접근 제어자로 캡슐화를 구현하는 법, 생성자 초기화 리스트를 본문 대입보다 우선해야 하는 이유, static 멤버와 friend를 정리합니다."
date: 2026-09-09
category: "Language"
categories:
  - Language
...
tags:
  ...
  - Classes
  - OOP
summary: "public/private/protected로 캡슐화를 강제하는 법, 생성자 초기화 리스트가 본문 대입보다 나은 이유, static 멤버와 friend의 쓰임을 정리합니다."
---

클래스는 데이터와 그 데이터를 다루는 함수를 하나로 묶는 설계도이고, 객체는 그 설계도로 만든 실제 인스턴스입니다. 이 글에서는 접근 제어자로 캡슐화를 강제하는 법, 생성자 초기화 리스트를 본문 대입보다 우선해야 하는 이유, 그리고 static 멤버와 friend까지 클래스 문법의 핵심을 다룹니다.
...
이전 글: [07. 포인터, 참조, 메모리 관리](./07-pointers-references-and-memory.pub.md)

다음 글: [09. 복사와 이동 의미론](./09-copy-and-move-semantics.pub.md)
