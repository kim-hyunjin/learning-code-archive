---
title: "[C++ 학습 노트 04] 제어문"
description: "if/switch/while/for와 범위 기반 for문을 예제로 살펴보고, switch의 fall-through와 off-by-one 오류 같은 흔한 함정을 정리합니다."
date: 2026-09-09
category: "Language"
categories:
  - Language
...
tags:
  - C++
  - ControlFlow
summary: "switch의 fall-through를 의도적으로 쓰는 패턴, do-while이 필요한 상황, 범위 기반 for에서 값 타입과 참조 타입의 차이를 정리합니다."
---

조건문과 반복문은 다른 언어와 크게 다르지 않지만, C++에는 `switch`의 fall-through를 의도적으로 활용하는 관례나 범위 기반 for에서 값 타입과 참조 타입을 구분해야 하는 이유처럼 알아두면 유용한 세부 사항이 있습니다.
...
이전 글: [03. 연산자](./03-operators.pub.md)

다음 글: [05. 배열과 벡터](./05-arrays-and-vectors.pub.md)
