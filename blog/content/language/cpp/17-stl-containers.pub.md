---
title: "[C++ 학습 노트 17] STL 컨테이너"
description: "vector, deque, list, stack, queue, priority_queue, set, map의 특성과 시간 복잡도를 비교하고 상황별 컨테이너 선택 기준을 정리합니다."
date: 2026-09-09
category: "Language"
categories:
  - Language
...
tags:
  ...
  - STL
  - Containers
summary: "끝에서의 추가/삭제가 빠른 vector부터 양쪽 끝이 빠른 deque, 정렬된 집합인 set과 map까지 STL 컨테이너별 시간 복잡도와 선택 기준을 표로 정리합니다."
---

STL은 자료구조를 직접 구현할 필요 없이 검증된 컨테이너들을 제공하지만, 어떤 연산이 잦은지에 따라 적합한 컨테이너가 달라집니다. 16장에서 다룬 클래스 템플릿이 실제로 어떻게 쓰이는지 볼 수 있는 대목이기도 합니다. 이 글에서는 대표적인 STL 컨테이너들의 특성과 시간 복잡도를 비교합니다.
...
이전 글: [16. 템플릿](./16-templates.pub.md)

다음 글: [18. 반복자와 알고리즘](./18-iterators-and-algorithms.pub.md)
